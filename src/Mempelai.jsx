          ...
          <div className="flex flex-row items-center md:justify-center w-full max-w-3xl ">
            <div className="md:w-1/3 flex justify-center">
                <div className="md:w-2/3 text-right mr-5" data-aos="flip-up" data-aos-duration="2000">
                    <h3 className="text-4xl font-sacramento text-orange-800">Aisyah Alqonita</h3>
                    <p>Putri dari Bapak Didit Sofyan Muaffif (Alm) dan Ibu Chas Kunarti</p>
                </div>
            </div>
            <img
                src="6.png"
          ...
          <div className="flex flex-row items-center md:justify-center w-full max-w-3xl">
            ...
            <div className="md:w-1/3 flex justify-center">
                <div className="md:w-2/3 text-left" data-aos="flip-right" data-aos-duration="2000">
                    <h3 className="text-4xl font-sacramento text-orange-800">Anang</h3>
                    <p>Putra dari Bapak Ngadi (Alm) dan Ibu Warni</p>
                </div>
            </div>
          </div>
        ...
        <div 
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <p className="mt-2 text-lg">Jumat, 11 April 2025</p>
              </div>
              <div>
